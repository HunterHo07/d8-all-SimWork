  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="max-w-md w-full bg-black/80 border border-indigo-500/50 rounded-xl p-8 text-center backdrop-blur-sm shadow-glow-blue">
        <h2 className="text-2xl font-bold mb-4">Scenario Details</h2>
        <p className="text-gray-400 mb-6">
          This is a static placeholder for scenario details. In the full app, this would show dynamic content.
        </p>
        <a
          href="/"
